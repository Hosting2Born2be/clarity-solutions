export const tab1 = [
    {
      id: 1,
      title: "What distinguishes a Card?",
      content:
        "A Card provides convenient access to global merchants and ATMs without the necessity of a traditional bank account or incurring credit card interest. It stores a predetermined amount of funds that decrease with each transaction.",
    },
    {
      id: 2,
  ...
  export const tab2 = [
    ...
    },
    {
      ...
      content:
        "A Virtual Card is a digital representation of your card, facilitating online or telephone payments and enabling online shopping. It offers a convenient and swift way to initiate transactions with your Account.",
    },
    {
      id: 12,
    ...
    },
    {
      ...
      content:
        'To check your card balance and view transaction history, login to your account at <a href="www.clarity-solutions.io">www.clarity-solutions.io</a>. Your balance will be prominently displayed, and you can access detailed transaction records under the Transaction History tab.',
    },
    {
      id: 15,
  ...
  export const tab3 = [
    {
      ...
      content:
        "Upon receipt of an activation email, follow the provided instructions.",
    },
    {
      id: 25,
      title: "I lost my activation email and password. What should I do?",
      content:
        'Contact us to request a reset of your password or click “Forgot Password” on the Sign In page.',
    },
    {
      id: 28,
      title: "What is the difference between my password and my PIN?",
      content:
        "Your password is used for online account access and activation, while your PIN (Personal Identification Number) is required for transactions at ATMs and Points of Sale.",
    },
    {
      id: 29,
  ...
  export const tab5 = [
    {
      ...
      content:
        'Your access code remains the same, Ensure correct case sensitivity when entering your username and password. Forgot your password? Reach out to <a href="mailto:info@clarity-solutions.io">info@clarity-solutions.io</a> for assistance.',
    },
    {
      id: 48,
